...
INSERT INTO Products (title, name ,category, price, unit, locations, picture, description, seller)
...
INSERT INTO Products (title, name ,category, price, unit, locations, picture, description, seller)
VALUES ('Cherry tomatoes', 'Tomatoes', 'Vegetables',2,'pcs', 'Kommendörsgatan 5', NULL, 
